...
function tsvcountrymusic_widgets_init() {
	...
	register_sidebar(
		array(
			'name'          => esc_html__( 'Footer', 'tsvcountrymusic' ),
			'id'            => 'footer-1',
			'description'   => esc_html__( 'Add widgets here.', 'tsvcountrymusic' ),
			'before_widget' => '<section id="%1$s" class="widget contacts-widget %2$s">',
			'after_widget'  => '</section>',
			'before_title'  => '<h2 class="widget-title">',
			'after_title'   => '</h2>',
		)
...
/**
 * Post lister editor features
 */
require get_template_directory() . '/inc/post-lister-inc.php';
