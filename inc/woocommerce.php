 ...
 * @return void
 */
function tsvcountrymusic_woocommerce_setup() {
	add_theme_support(
		'woocommerce',
		array(
 ...
 * @return void
 */
function tsvcountrymusic_woocommerce_scripts() {
	wp_enqueue_style( 'tsvcountrymusic-woocommerce-style', get_template_directory_uri() . '/woocommerce.css', array(), TSVCOUNTRYMUSIC_VERSION );
...
if ( ! function_exists( 'tsvcountrymusic_woocommerce_wrapper_before' ) ) {
	/**
	 * Before Content.
	 *
...
add_action( 'woocommerce_before_main_content', 'tsvcountrymusic_woocommerce_wrapper_before' );

if ( ! function_exists( 'tsvcountrymusic_woocommerce_wrapper_after' ) ) {
	/**
	 * After Content.
	 *
...
add_action( 'woocommerce_after_main_content', 'tsvcountrymusic_woocommerce_wrapper_after' );
...
if ( ! function_exists( 'tsvcountrymusic_woocommerce_cart_link_fragment' ) ) {
	...
	function tsvcountrymusic_woocommerce_cart_link_fragment( $fragments ) {
		ob_start();
		tsvcountrymusic_woocommerce_cart_link();
		$fragments['a.cart-contents'] = ob_get_clean();

		return $fragments;
	}
}
add_filter( 'woocommerce_add_to_cart_fragments', 'tsvcountrymusic_woocommerce_cart_link_fragment' );

if ( ! function_exists( 'tsvcountrymusic_woocommerce_cart_link' ) ) {
	/**
	 * Cart Link.
	 *
...
if ( ! function_exists( 'tsvcountrymusic_woocommerce_header_cart' ) ) {
	 ...
	 * @return void
	 */
	function tsvcountrymusic_woocommerce_header_cart() {
		if ( is_cart() ) {
		...
		<ul id="site-header-cart" class="site-header-cart">
			<li class="<?php echo esc_attr( $class ); ?>">
				<?php tsvcountrymusic_woocommerce_cart_link(); ?>
			</li>
			<li>
				<?php
				$instance = array(
