 ...
 */
function tsvcountrymusic_customize_register( $wp_customize ) {
	...
	if ( isset( $wp_customize->selective_refresh ) ) {
		$wp_customize->selective_refresh->add_partial(
			...
			array(
				...
				'render_callback' => 'tsvcountrymusic_customize_partial_blogname',
			)
		);
		$wp_customize->selective_refresh->add_partial(
			'blogdescription',
			array(
				...
				'render_callback' => 'tsvcountrymusic_customize_partial_blogdescription',
			)
		);
	}
}
 ...
 * @return void
 */
function tsvcountrymusic_customize_partial_blogname() {
	bloginfo( 'name' );
}
 ...
 * @return void
 */
function tsvcountrymusic_customize_partial_blogdescription() {
